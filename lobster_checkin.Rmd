...
compiled and on your `$PATH`.  (actually at this point you will need to change the absolute path
`/Users/eriq/Documents/git-repos/gsi_sim/gsisim` to whatever it would be on your system.)
...
Here is a quick sanity check that could be done.: permute the individuals in the data set and randomly allocate them
to two different groups: Fake1 and Fake2, say, of the same size as the North and South and then see how well we can allocate them.  I expect, not at all
